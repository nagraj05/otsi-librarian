    ...
    <div className="min-h-screen">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="space-y-1.5">
              ...
              <div className="h-2.5 w-28 bg-muted/60 animate-pulse rounded-full hidden sm:block" />
            </div>
          </div>
          <div className="flex items-center gap-3">
            <div className="h-3.5 w-16 bg-muted/60 animate-pulse rounded-full hidden sm:block" />
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-10">
        ...
        <div className="grid grid-cols-3 gap-3 sm:gap-4 mb-8">
          {[...Array(3)].map((_, i) => (
            <div key={i} className="bg-card rounded-2xl p-4 sm:p-5 ring-1 ring-foreground/5 shadow-sm space-y-2">
        ...
        <div className="hidden sm:block bg-card rounded-3xl ring-1 ring-foreground/5 shadow-sm overflow-hidden">
          <div className="border-b border-border px-6 py-4 flex gap-6">
            {['w-48', 'w-24', 'w-20', 'w-20', 'w-16', 'w-10'].map((w, i) => (
              <div key={i} className={`h-2.5 ${w} bg-muted/60 animate-pulse rounded-full`} />
            ))}
          </div>
          {[...Array(5)].map((_, i) => (
            <div key={i} className="border-b border-border/50 last:border-0 px-6 py-4 flex items-center gap-6">
              <div className="flex items-center gap-3.5 flex-1">
                <div className="w-9 h-12.5 rounded-xl bg-muted/60 animate-pulse shrink-0" />
                <div className="space-y-1.5">
              ...
              <div className="h-7 w-16 bg-muted/60 animate-pulse rounded-lg ml-auto" />
            </div>
          ))}
        </div>
        ...
        <div className="sm:hidden space-y-3">
          {[...Array(4)].map((_, i) => (
            <div key={i} className="bg-card rounded-2xl ring-1 ring-foreground/5 shadow-sm p-4 space-y-3">
